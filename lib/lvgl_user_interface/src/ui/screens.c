...
void create_screen_main() {
    ...
    lv_obj_set_size(obj, 320, 240);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 190, 44);
            lv_obj_set_style_bg_opa(obj, 1200, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xffde90a0), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_opa(obj, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_grad_color(obj, lv_color_hex(0xffbe99c6), LV_PART_MAIN | LV_STATE_DEFAULT);
